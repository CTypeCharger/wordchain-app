...
const getWordImage = async (word) => {
  try {
    ...
    const unsplashKey = '5Aq-5i4U8HT_iqM6DIc621YmS0gm3Fn-JGx3yRQFLi8';
      ...
      <div className="bg-white p-4 md:p-6 rounded-xl shadow">
        ...
        <div className="text-center mb-6">
          ...
          <div className="mb-6 flex justify-center">
            <div className="w-40 h-40 md:w-48 md:h-48 rounded-xl overflow-hidden bg-gray-100 flex items-center justify-center shadow-lg">
              {currentImage ? (
                <img 
                  src={currentImage} 
              ...
              <div key={item.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                <div className="flex gap-4">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
